...
@section('content')
    ...
    <div class="page-header">
        <div>
            ...
            <div class="sub">Unggah foto kegiatan desa</div>
        </div>
        ...
        <div class="row g-3">
            <div class="col-lg-8">
                <div class="form-card">
                    ...
                    <div class="mb-3">
                        <label class="form-label-custom">File Foto <span class="text-danger">*</span></label>
            ...
            <div class="col-lg-4">
                <div class="form-card">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan" class="form-control-custom" rows="3" placeholder="Deskripsi foto (opsional)...">{{ old('keterangan') }}</textarea>
                    </div>
