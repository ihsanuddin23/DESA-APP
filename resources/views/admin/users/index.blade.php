...
@section('content')
    ...
    <form method="GET" class="filter-bar">
        <div class="search-wrap">
            ...
            <input type="text" name="search" class="filter-input" placeholder="Cari nama, email..."
                        ...
                        <tr>
                            ...
                            <td>
                                @php
                                    ...
                                    $rc = $roleColors[$user->role] ?? ['#f1f5f9', '#64748b'];
                                @endphp
                            ...
                            <td>
                                ...
                                @else
                                    <span class="status-badge badge-danger"><i class="bi bi-circle-fill"
