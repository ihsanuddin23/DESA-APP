...
<form method="GET" class="filter-bar">
    ...
    <div class="search-wrap">
        ...
        <input type="text" name="ip" class="filter-input" placeholder="Filter IP address..." value="{{ request('ip') }}" style="min-width:180px;">
    </div>
...
<div class="data-card">
                ...
                <tr>
                    <td class="ps-4">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                                <div style="font-weight:600;font-size:.82rem;color:#0f172a;">{{ e($log->user->name) }}</div>
                    ...
                    <td style="max-width:200px;">
                        <span style="font-size:.8rem;color:#475569;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:block;max-width:200px;">
                            {{ $log->description ?? '—' }}
                        </span>
                    </td>
                    ...
                    <td class="pe-4" style="white-space:nowrap;">
                        <div style="font-size:.8rem;color:#0f172a;font-weight:500;">{{ $log->created_at->format('d M Y') }}</div>
    ...
    <div style="padding:.85rem 1.25rem;border-top:1px solid #f1f5f9;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:.5rem;">
        <span style="font-size:.78rem;color:#94a3b8;">Halaman {{ $logs->currentPage() }} dari {{ $logs->lastPage() }}</span>
        {{ $logs->links() }}
    </div>
    @endif
</div>
